---
name: _defaults
description: Shared configuration inherited by all MAO agents. Not a standalone agent.
---

# MAO Agent Defaults

Shared configuration inherited by all MAO agents. Do not duplicate in individual agent files.
